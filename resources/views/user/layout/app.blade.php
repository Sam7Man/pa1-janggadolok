...
<head>
    ...
    <title>{{ config('app.name', 'Desa Jangga Dolok') }}</title>
                ...
                <div class="nav navbar-nav" id="collapsibleNavId">
                    <div class="nav-items">
                        <div href="" class="nav-links">
                            <a href="{{ url('home') }}" class="link"><i class="fas fa-tachometer-alt icon"></i>Dashboard</a>
                        </div>
                    </div>
                    <div class="nav-items">
                        <div href="" class="nav-links">
                            <a href="{{ url('booking') }}" class="link"><i class="fas fa-book icon"></i>
                                Booking</a>
                        </div>
                    </div>
                    <div class="nav-items">
                        <div href="" class="nav-links">
                            <a href="{{ url('detail') }}" class="link"><i class="fas fa-book icon"></i>
                                Details</a>
                        </div>
                    </div>
                </div>
